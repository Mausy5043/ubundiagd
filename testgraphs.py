...
def graphs():
  ...
  pl.savefig('/tmp/ubundiagd/C123.png')
  ...
  pl.grid(True)
  pl.savefig('/tmp/ubundiagd/C56.png')
  ...
  pl.legend(loc='upper left', prop={'size':8})
  pl.gcf().autofmt_xdate()
  pl.savefig('/tmp/ubundiagd/D123.png')
  ...
  pl.grid(True)
  pl.gcf().autofmt_xdate()
  pl.savefig('/tmp/ubundiagd/D4.png')
  ...
  #pl.grid(True)
  #pl.gcf().autofmt_xdate()
  #pl.savefig('/tmp/ubundiagd/D56.png')
  ...
  pl.legend(loc='upper left', prop={'size':8})
  pl.gcf().autofmt_xdate()
  pl.savefig('/tmp/ubundiagd/D7.png')
  ...
  pl.grid(True)
  pl.gcf().autofmt_xdate()
  pl.savefig('/tmp/ubundiagd/D8.png')
  ...
  # SyntaxError: Non-ASCII character '\xe2' in file /home/pi/ubunboot/testgraphs.py
